package com.cpwr.gdo.simulator.web.page;
 ...
 * <tt>"border-template.htm"</tt>, and sets the Page model values
 * <tt>$title</tt> and <tt>$srcPath</tt>.
 * <p/>
...
public abstract class BorderPage extends Page {
     ...
     * 
     */
    private static final long serialVersionUID = -3330977018191864796L;
    /**
    ...
    public BorderPage() {
        ...
        addModel("helpPage", getHelpPageLink());
    }
     ...
     * <p/>
     * Please note this page is designed for extending by Page subclasses and
     * will not be auto mapped as the template name
     * <tt>"border-template.htm"</tt> does not match the Pages class name
     * <tt>BorderPage</tt>.
     * 
    ...
    public abstract String getHelpPageLink();
