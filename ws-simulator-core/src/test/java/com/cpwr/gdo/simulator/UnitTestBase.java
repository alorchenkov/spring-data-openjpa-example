 ...
 * <p/>
 * <ul>
 * <li>{@link org.junit.rules.TestWatcher}: adds logic at events during method
 * execution;</li>
 * </ul>
 * <p/>
...
public abstract class UnitTestBase {
     ...
     */
    private static void initializeSlf4jConfig() throws IOException {
        /* Initialize log4j */
        String logback = "file:" + testPropsDir + fsep + "logback-test.xml";
        setProperty("logback.configurationFile", logback);
    }
    ...
    public TestWatcher methodLogger = new TestWatcher() {
        ...
        private String getShortTestMethodName(final Description descr) {
            ...
            if (descr != null) {
                final String[] fullTestClassName = split(descr.getClassName(), ".");
                result = fullTestClassName[fullTestClassName.length - 1] + "." + descr.getMethodName();
            } else {
                getLog().debug("Description must not be null!");
            }
